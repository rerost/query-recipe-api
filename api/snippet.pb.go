...
func (*ListSnippetsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{0}
}
...
func (dst *ListSnippetsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListSnippetsRequest.Merge(dst, src)
}
...
func (*ListSnippetsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{1}
}
...
func (dst *ListSnippetsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListSnippetsResponse.Merge(dst, src)
}
...
func (*GetSnippetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{2}
}
...
func (dst *GetSnippetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSnippetRequest.Merge(dst, src)
}
...
func (*CreateSnippetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{3}
}
...
func (dst *CreateSnippetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateSnippetRequest.Merge(dst, src)
}
...
func (*UpdateSnippetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{4}
}
...
func (dst *UpdateSnippetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateSnippetRequest.Merge(dst, src)
}
...
func (*DeleteSnippetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_snippet_f89a260d4b043277, []int{5}
}
...
func (dst *DeleteSnippetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteSnippetRequest.Merge(dst, src)
}
...
func init() { proto.RegisterFile("snippet.proto", fileDescriptor_snippet_f89a260d4b043277) }

var fileDescriptor_snippet_f89a260d4b043277 = []byte{
